  ...
  isEmpty(rawEmailPayload)
    ...
    : isEmpty(rawEmailPayload.content)
      ...
      : isEmpty(rawEmailPayload.subject)
        ...
        : !isValidEmailArray(rawEmailPayload.toAddress) ||
      !emailArrayValidation(rawEmailPayload.toAddress)
          ? errorMessage(emailValidationErrorMessage)
          : isValidEmailArray(rawEmailPayload.ccAddress) &&
      !emailArrayValidation(rawEmailPayload.ccAddress)
            ? errorMessage(emailValidationErrorMessage)
            : isValidEmailArray(rawEmailPayload.bccAddress) &&
      !emailArrayValidation(rawEmailPayload.bccAddress)
              ? errorMessage(emailValidationErrorMessage)
